...
namespace Warp::nri::vk
{
    ...
    struct NriBufferInfo
    {
        ...
        /// @brief Must be specified as a bitmask of VkBufferUsageFlagBits values. See VkBufferUsageFlagBits for more details on individual usage bits.
        VkBufferUsageFlags usage = VK_BUFFER_USAGE_FLAG_BITS_MAX_ENUM;
        
        /// @brief Size of the buffer in bytes. Must be greater than 0.
        size_t sizeInBytes = 0;

        /// @brief Optional flags for memory allocation of this buffer. See VmaAllocationCreateFlagBits for more details on individual bits.
        VmaAllocationCreateFlags memoryAllocationFlags = VMA_ALLOCATION_CREATE_FLAG_BITS_MAX_ENUM;

        /// @brief Memory usage for this buffer, specified as VMA_MEMORY_USAGE enum value. See VMA_MEMORY_USAGE enum for more details on individual values.

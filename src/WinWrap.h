...
namespace Warp::WinWrap
{
    ...
    // Input/Output namespace covers win input
    namespace IO
    {
    ...
    // Inn namespace stores utility functions to handle application's entry scope that does not go further down the runtime
    namespace Inn
    {
